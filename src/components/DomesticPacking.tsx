          ...
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-xl shadow-slate-200/50 transition-all hover:shadow-2xl">
            ...
            {file && (
              <button
                  ...
                  title={file.type.startsWith('image/') ? '업로드한 이미지에 서명을 추가해서 다운로드합니다' : (results ? '변환 결과 화면을 캡쳐해서 서명을 추가합니다' : 'PDF/엑셀은 먼저 데이터를 변환한 뒤 이용할 수 있어요')}
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 py-3 rounded-xl bg-slate-900 text-white font-bold text-sm hover:bg-black transition-colors"
                      >
                        서명 추가
                      </button>
                    </div>
